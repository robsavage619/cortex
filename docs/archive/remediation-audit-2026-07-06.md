...
[suspicious_tickers]
  ...
  universe: S&P 500 union S&P 400 (903 tickers)
...
- Insider (8,591) and activist (1,626) row counts are the before-numbers for
  ...
  collapse loss.
- All 30 executive mentions have `meaningful IS NULL`, so none were ever
...
| activist_stakes | 1,626 | 1,546 | -80 | not a clean damage measure: old rows accumulated across years of S&P-500 universe drift; the new count is one consistent fetch (2014 to now, today's universe) with the finer key |

## Phase 2 backfill (2026-07-06, schema v15 to v16)
...
- Post-backfill audit: `excess_rows_unmarked: 0`, so every natural-key
...
| L/S spread | (not tracked) | 2.98 | n/a | first measurement |

**None clear the t >= 3.0 gate.** No live trading until at least one factor does.
